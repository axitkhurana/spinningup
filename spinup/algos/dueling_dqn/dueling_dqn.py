...
import gym
import time
from spinup.algos.dueling_dqn import core
from spinup.algos.dueling_dqn.core import get_vars, copy_operation
...
"""
def dueling_dqn(env_fn, actor_critic=core.mlp_actor_critic, ac_kwargs=dict(), seed=0,
...
if __name__ == '__main__':
    ...
    dueling_dqn(lambda : gym.make(args.env), actor_critic=core.mlp_actor_critic,
